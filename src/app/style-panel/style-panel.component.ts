...
export class StylePanelComponent implements OnInit {
  ...
  constructor(private service: DataService) {
    ...
    this.textColor=this.service.color;
    this.fontSizes=this.service.fontSizes;
   }
  ...
  sendTextDecoration(value:any){
    this.changeTextDecoration.emit(this.service.changeTextDecoration(value))
  }
  colorPanel(){
